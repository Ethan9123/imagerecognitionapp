...
mean_face_arr = pca_model['mean_face'] #Mean face
...
def faceRecognitionPipeline(filename, path=True):
    ...
    for x,y,w,h in faces:
        ...
        roi_mean = roi_reshape - mean_face_arr.to_numpy() #subtract face with mean face
        ...
        cv2.rectangle(img,(x-4,y-40),(w+x+5,y),color,-1)
